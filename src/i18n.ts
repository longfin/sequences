...
const messages = {
  ...
  syncIncompatible: {
    ko: '클라우드의 책이 더 새 버전입니다. 앱을 업데이트하세요.',
    en: 'The cloud book uses a newer format. Update the app.',
    ja: 'クラウドの本は新しい形式です。アプリを更新してください。',
  },
  syncFailed: { ko: '동기화 오류', en: 'Sync error', ja: '同期エラー' },
  syncFailedTitle: {
    ko: '동기화 기능에 문제가 생겼습니다. 누르면 이 기기에서 로그아웃하고 다시 불러옵니다.',
    en: 'Sync ran into a problem. Click to log out on this device and reload.',
    ja: '同期に問題が発生しました。押すとこのデバイスでログアウトして再読み込みします。',
  },
  remoteDeleted: { ko: '다른 기기에서 삭제됨', en: 'deleted elsewhere', ja: '他のデバイスで削除' },
  remoteDeletedTitle: {
    ko: '다른 기기에서 이 사진을 삭제했습니다. 원본은 이 기기에만 있어서 트레이에 남겨 두었습니다. 다시 배치하면 다른 기기에도 돌아갑니다.',
    en: 'Another device deleted this photo. The original exists only here, so it stays in the tray. Placing it again brings it back everywhere.',
    ja: '他のデバイスでこの写真を削除しました。オリジナルはここにしかないためトレイに残しています。再配置すると他のデバイスにも戻ります。',
  },
  syncUploadTitle: { ko: '이 기기의 책을 올릴까요?', en: 'Upload this device’s book?', ja: 'このデバイスの本をアップロードしますか？' },
  syncUploadBody: {
    ko: '이 계정은 비어 있고, 이 기기에는 다른 계정에서 받은 사진이 남아 있습니다. 올리면 그 사진도 이 계정에 들어갑니다.',
    en: 'This account is empty, and this device still holds photos from another account. Uploading puts them in this account too.',
    ja: 'このアカウントは空で、このデバイスには別のアカウントから受け取った写真が残っています。アップロードするとそれらもこのアカウントに入ります。',
  },
  ...
  syncMergeTakeRemote: {
    ko: '클라우드 시퀀스 유지 (이 기기 것은 교체)',
    en: 'Keep the cloud sequence (this device’s is replaced)',
    ja: 'クラウドのシーケンスを残す（このデバイスは置き換え）',
  },
  syncMergeKeepLocal: {
    ko: '이 기기 시퀀스 유지 (클라우드는 교체)',
    en: 'Keep this device’s sequence (the cloud is replaced)',
    ja: 'このデバイスのシーケンスを残す（クラウドは置き換え）',
  },
